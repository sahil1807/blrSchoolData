blrData.controller('SignupController', ['$rootScope', '$scope', '$element' , '$http', '$location', 'AuthService', '$state', function($rootScope, $scope, $element, $http, $location, AuthService, $state) {
